...
describe('PDFView', () => {
  ...
  it('invokes onLoad callback', () => {
    ...
    const tree = renderer.create(
      <PDFVIew onLoad={onLoad} resource="base64" resourceType="base64" />
    );
  ...
  it('invokes onError callback', () => {
    ...
    const tree = renderer.create(
      <PDFVIew onError={onError} resource="base64" resourceType="base64" />
    );
  ...
  it('invokes onPageChanged callback', () => {
    ...
    const tree = renderer.create(
      <PDFVIew onPageChanged={onPageChanged} resource="base64" resourceType="base64" />
    );
  ...
  it('uses default callbacks', () => {
    const onLoad = jest.fn();
    const tree = renderer.create(
      <PDFVIew resource="base64" resourceType="base64" onLoad={onLoad} />
    );
